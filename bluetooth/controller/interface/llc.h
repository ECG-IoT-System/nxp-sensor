...
/// LLC environment structure
struct llc_env_tag_patch
{
    /// cursor to last channel re-assess
    uint8_t reassess_cursor;
    uint32_t prev_winsize_cs;
    uint32_t prev_winsize_us;
};
...
extern struct llc_env_tag_patch** llc_env_patch;
...
/**
 ****************************************************************************************
 * @brief Disable the ping request function
 *
 * @param[in] flag        enable or disable flag
 ****************************************************************************************
 */
void llc_disable_ping_request(bool flag);


/**
 ****************************************************************************************
 * @brief get the ping request flag
 *
 * @param[in] flag        enable or disable flag
 ****************************************************************************************
 */

bool llc_get_ping_request_flag(void);
